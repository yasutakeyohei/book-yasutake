...
市は、令和2年10月から令和3年1月まで、QRコード決済を利用した、キャッシュレスポイントキャンペーンを実施しました。その際、予算を約1.4億円も超過し、令和2年度一般会計補正予算（第8号）で穴埋めがなされました。穴埋めのために使われたのは、教育費として確保されていた分の約8千万円です。この穴埋めがなければ、教育費としてさまざま用途に使えたお金です。あり得ないことと思います。

原因のひとつは、QR決済事業者が上限を設定できない仕組みにしており、そのような欠陥のある制度を東京都が推進していることです。小平市は、そのような仕組みなら、この制度に手を出すべきではありませんでした。なお、私は東京都が完全に機能不全を呈していると思っています。
...
- 現金決済限定の大型店が活気付いているのは → 商品の種類や量が多く薄利多売
- 決済手数料以外に決済事業者に払った金額は → 前回約430万円、今回約970万円
- 予算書にも事業者に払う金額の記載を → 即答できないが委員会等で説明できれば
