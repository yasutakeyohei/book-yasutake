...
なお、各自治体の「規模感」を把握するために、全児童・生徒数を、正規化したマイナスの数値で示しました。つまり、最も児童・生徒数が多いのは八王子市で、小学校の全児童数は26,109人いますが、これが0.04となるように正規化しています。たとえば、町田市は21,573人いるので、0.04/26109 x 21573 = 0.033となり、町田市は規模が-0.033で示されています。
