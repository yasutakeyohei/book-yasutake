...
コロナ禍で市税収入はどれくらい減少するか、その事態にどう対応するか、公共施設の縮小を加速することにならないか、などを確認しました。また、地域活動を維持するために、オンライン・ハイブリッド開催の推進と、[情報格差](https://ja.wikipedia.org/wiki/%E6%83%85%E5%A0%B1%E6%A0%BC%E5%B7%AE)が広がらないよう、市のサポートが必要であることを訴えました。

また、市長に対して、補正予算4号の内容があまりにもひどかった理由が、職員約千人の知恵が集結する仕組みがないこと、市長が責任を取る態度を見せないことが原因ではないかと指摘しました。市長はこれに対し「[（発言を）撤回していただきたい](#sityou-kyouben)」という答弁をしたため、とても驚きました。

- 現時点で、市税歳入の減少見込みは → 厳しい状況にある
- 歳入減少で公共施設の規模縮小を早めるか → 当面の対応で早める予定はない
- コロナ禍で公共施設の1日平均利用者数は → 7月は図書館約2割減、他6～9割大幅減
- ↑ 今後の見込みは → 感染状況にもよるが、図書館以外は急激な回復なしを見込む
...
- ↑ 希望者にタブレット等を貸与しネット併用開催を実験しては → 貸与考えてない
- 市の委員会等のオンライン開催状況は → 4つの委員会・審議会で8回開催
- ↑ 課題は → 職員の習熟度や参加者の通信環境でオンライン参加不能な場合がある
- 市民1人1台タブレット完備の小平市を目指しては → 市民への配布は現在考えていないが経済的理由で情報端末を保有できない方への対応などは今後の課題になる
- Web図書館については検討しているか → 検討はしていないが、情報収集に努める
