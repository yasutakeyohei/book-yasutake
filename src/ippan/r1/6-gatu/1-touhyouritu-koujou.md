...
国政選挙や東京都の選挙では、もうちょっとタイムラグが長くなり、さらに、国や東京都のホームページのアドレスがどの段階で決まるのか、それをどの段階で啓発物にQRコードを印刷できるのかという、このさらにタイミングが非常に難しい。というのは、啓発物は、日にちが決まればすぐつくり出してしまう。その後にホームページにアップされ、そのアドレスが決まるということになると、うまく説明できないが、QRコードを印刷できるのが大分後になる、つまり啓発物をつくるタイミングとうまく合わないというところがひとつネックになるかと考える。
